...
image:https://github.com/{project-full-path}/workflows/CI/badge.svg["Java CI with Gradle", link="https://github.com/{project-full-path}/actions?query=workflow%3A%22CI%22"]
